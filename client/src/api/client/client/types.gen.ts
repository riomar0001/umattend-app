...
export type Options<TData extends TDataShape = TDataShape, ThrowOnError extends boolean = boolean, TResponse = unknown> = OmitKeys<
...
export type OptionsLegacyParser<TData = unknown, ThrowOnError extends boolean = boolean> = TData extends { body?: any }
  ? TData extends { headers?: any }
    ...
    : OmitKeys<RequestOptions<unknown, ThrowOnError>, 'body' | 'url'> & TData & Pick<RequestOptions<unknown, ThrowOnError>, 'headers'>
  : TData extends { headers?: any }
    ? OmitKeys<RequestOptions<unknown, ThrowOnError>, 'headers' | 'url'> & TData & Pick<RequestOptions<unknown, ThrowOnError>, 'body'>
